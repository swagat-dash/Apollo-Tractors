/* ===================================================================
    ...
    Author          : Valid Theme
    Template Name   : Tractors and Implements | Apollo Fieldtrack Earthmovers
    Version         : 1.0
...
(function($) {
    ...
    $(document).on('ready', function() {
        ...
        var headertext = [],
  headers = document.querySelectorAll("#specifications th"),
  tablerows = document.querySelectorAll("#specifications th"),
  tablebody = document.querySelector("#specifications tbody");
